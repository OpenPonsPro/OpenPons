...
import { X_URL } from '../lib/brand.ts'
import { WalletModal } from './WalletModal.tsx'
import { ProfileMenu } from './ProfileMenu.tsx'
import { CLAIM_REPO, EXPLORE, HOME, HOW, LAUNCH, type Route } from '../lib/router.ts'
...
const ITEMS = [
  ...
  { href: CLAIM_REPO, label: 'Claim', on: (r: Route) => r.name === 'claim-repo' },
  ...
  return (
    <header className="hdr">
      <div className="hdr__in">
        <Link className="hdr__brand" to={HOME}>
        ...
        <div className="hdr__right">
          {X_URL && (
            <a className="hdr__x" href={X_URL} target="_blank" rel="noreferrer noopener" aria-label="OpenPons on X">
              <XIcon />
            </a>
          )}

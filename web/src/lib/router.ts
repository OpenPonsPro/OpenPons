 ...
 * Real paths, no hash.
 *
 * ⚠⚠ THIS ONLY WORKS BECAUSE THE WEB SERVER FALLS BACK TO index.html. The SPA fallback is what
...
export function parsePath(pathname: string): Route {
  ...
  if (p === '/claim-repo') return { name: 'claim-repo' }
...
export const CLAIM_REPO = '/claim-repo'

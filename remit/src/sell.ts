 ...
 * Uniswap V4 singleton first and bridged as USDG. `OpenPonsDistributor.sellAllForUsdg` does the swap;
 ...
 * loss, it is the project paying to destroy its own donation.
 */
